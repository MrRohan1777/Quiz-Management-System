...
//    private String rollno1;
    ...
    public instructionStudent(String rollNo1) {
        initComponents();
//        JOptionPane.showInternalMessageDialog(null, rollNo1);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 1538, 10));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Segoe UI", 1, 25)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("During the exam:\n\n1.The student may notuse his or her textbook, course notes, or receive help from a\n   protcor or any other outside source.\n\n2.Student must complete the 10-questions multiple-choice exam within the 10-minute time\n    frame alloted for the exam.\n\n3.Student must not stop the session and then return to it . this is especially important\n    in the online enviroment where the system will \"time-out\" and not allowed the student\n    or you to recenter the exam.\n\n\nNumber of Quistion:10\nExam Duration: 10 min\nALL THE BEST...!");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 1445, 590));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 730, -1, -1));
